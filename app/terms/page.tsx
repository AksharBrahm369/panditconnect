...
export default function TermsPage() {
  return <LegalPage title="Platform terms" summary="PanditConnect is a marketplace that helps customers discover and coordinate with independently verified Pandits.">
