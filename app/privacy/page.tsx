...
export default function PrivacyPage() {
  return <LegalPage title="Privacy notice" summary="This notice explains what PanditConnect collects, why it is needed, and the choices available to customers and Pandits.">
