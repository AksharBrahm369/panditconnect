...
type PrivacyRequest={id:string;request_type:string;status:string;details:string|null;resolution:string|null;requested_at:string;role:string;name:string|null;phone:string};
